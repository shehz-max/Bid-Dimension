...
export const metadata: Metadata = {
  ...
  description:
    'Full-service structural engineering, architectural design, and MEP services. PE-stamped drawings, 10-12 day turnaround. Get your free quote today.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Full-service structural engineering, architectural design, and MEP services. PE-stamped drawings, 10-12 day turnaround.',
    images: [
      {
        url: '/og-image.png',
        width: 1200,
