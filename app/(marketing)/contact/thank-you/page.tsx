...
export const metadata: Metadata = {
  ...
  description:
    'Thank you for submitting your engineering proposal request. Our PE structural engineering team is reviewing your plans and will respond within 24-48 hours.',
  robots: {
    index: false,
    follow: false,
  },
    ...
    <div className="min-h-screen pt-36 pb-24 bg-bd-navy-deep blueprint-grid text-white flex flex-col items-center justify-center relative overflow-hidden">
      <div className="max-w-3xl mx-auto px-5 sm:px-8 text-center relative z-10">
        ...
        <p className="font-body text-lg text-bd-text-muted leading-relaxed mb-10 max-w-xl mx-auto">
          We have received your project details and uploaded plans. Our licensed Professional Engineers (PE) are evaluating your scope and will send a fixed-fee proposal within <strong className="text-bd-blue">24 to 48 hours</strong>.
        </p>
